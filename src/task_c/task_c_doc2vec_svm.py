...
# dm_svm_model = pre.svm_polarity_model(model=model_dm,train_data=train_data, multi=True)
# polarity_model(model, train_data, multi, tuning=True):
dm_svm_model = pre.polarity_model(d2v_model=model_dm,model='svm', train_data=train_data, multi=True)
dbow_svm_model = pre.polarity_model(d2v_model=model_dbow,model='svm', train_data=train_data, multi=True)
