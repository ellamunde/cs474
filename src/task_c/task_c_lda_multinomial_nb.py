...
mnb_polarity_model = pre.polarity_model(lda_model=lda_model, model='mnb', vectorizer=vectorizer, topic_words_dist=topic_words_dist, train_data=train_data, multi=True)
