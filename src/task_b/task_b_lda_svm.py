...
svm_polarity_model = pre.polarity_model(lda_model=lda_model, model='svm', vectorizer=vectorizer, topic_words_dist=topic_words_dist, train_data=train_data, multi=False)
prediction = pre.polarity_test(lda_model, svm_polarity_model, vectorizer, topic_words_dist, test_set)
