...
dm_svm_model = pre.svm_polarity_model(model=model_dm,train_data=train_data, multi=False)
dbow_svm_model = pre.svm_polarity_model(model=model_dbow,train_data=train_data, multi=False)
