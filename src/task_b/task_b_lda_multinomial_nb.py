...
mnb_polarity_model = pre.polarity_model(lda_model=lda_model, model='mnb', vectorizer=vectorizer, topic_words_dist=topic_words_dist, train_data=train_data, multi=False)
prediction = pre.polarity_test(lda_model, mnb_polarity_model, vectorizer, topic_words_dist, test_set)
...
#
# train_model = multinomial_nb.split_and_train(bow_vectorizer, polarity)
# train_model_lda = multinomial_nb.split_and_train(csr_matrix_train, polarity)
#
