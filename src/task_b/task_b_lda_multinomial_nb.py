...
mnb_polarity_model = pre.multinomial_nb_polarity_model(lda_model, vectorizer, topic_words_dist, train_data, multi=False)
prediction = pre.multinomial_nb_polarity_test(lda_model, mnb_polarity_model, vectorizer, topic_words_dist)
